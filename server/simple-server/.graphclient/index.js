...
exports.getSdk = exports.PoliciesCreatedQueryDocument = exports.getBuiltGraphSDK = exports.subscribe = exports.execute = exports.getBuiltGraphClient = exports.createBuiltMeshHTTPHandler = exports.getMeshOptions = exports.rawServeConfig = void 0;
...
const importedModule$0 = tslib_1.__importStar(require("./sources/zkDoctor/introspectionSchema.json"));
...
const importFn = (moduleId) => {
    ...
    switch (relativeModuleId) {
        case ".graphclient/sources/zkDoctor/introspectionSchema.json":
...
async function getMeshOptions() {
    ...
    const zkDoctorTransforms = [];
    const additionalTypeDefs = [];
    const zkDoctorHandler = new graphql_1.default({
        name: "zkDoctor",
        config: { "endpoint": "https://api.studio.thegraph.com/query/39401/zkdoctor/version/latest" },
        baseDir,
        cache,
        pubsub,
        store: sourcesStore.child("zkDoctor"),
        logger: logger.child("zkDoctor"),
        importFn,
    });
    sources[0] = {
        name: 'zkDoctor',
        handler: zkDoctorHandler,
        transforms: zkDoctorTransforms
    };
    ...
    return {
        ...
        get documents() {
            return [
                {
                    document: exports.PoliciesCreatedQueryDocument,
                    get rawSDL() {
                        return (0, utils_4.printWithCache)(exports.PoliciesCreatedQueryDocument);
                    },
                    location: 'PoliciesCreatedQueryDocument.graphql'
                }
            ];
        },
...
exports.PoliciesCreatedQueryDocument = (0, utils_1.gql) `
    query PoliciesCreatedQuery {
...
function getSdk(requester) {
    return {
        PoliciesCreatedQuery(variables, options) {
            return requester(exports.PoliciesCreatedQueryDocument, variables, options);
        }
    };
}
